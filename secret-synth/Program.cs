...
/*1*/           options.AddEncryptionKey(new SymmetricSecurityKey(
        ...
        await using (var scope = app.Services.CreateAsyncScope())
        {
            ...
            async Task CreateApplicationsAsync()
            {
                ...
                if (await manager.FindByClientIdAsync("resource_server_1") is null)
                {
                    await manager.CreateAsync(new OpenIddictApplicationDescriptor
                    {
/*2*/                   ClientId = "resource_server_1",
/*3*/                   ClientSecret = "846B62D0-DEF9-4215-A99D-86E6B8DAB342",
                        Permissions =
                {
        ...
        _ = app.MapGet("/authorize", async (HttpContext context, IOpenIddictScopeManager manager) =>
        {
